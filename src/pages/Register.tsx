...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 py-12">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-primary/20 rounded-full blur-3xl animate-float animation-delay-300" />

      <Card variant="glass" className="w-full max-w-md p-8 relative z-10 animate-scale-in">
        {/* Logo */}
        <Link to="/" className="flex items-center justify-center gap-2 mb-8">
          <img src="/premio-logo.png" alt="Premio" className="w-12 h-12 rounded-xl object-cover" />
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Bergabung dengan Premio sekarang</p>
        </div>
